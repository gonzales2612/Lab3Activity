        ...
        if (move_uploaded_file($temporary_file, $uploaded_file)) {
            switch ($type) {
                case 'text':
                    ...
                    echo "<textarea cols='70' rows='10'>" . htmlspecialchars($file_content) . "</textarea><br>";
                    break;

                case 'pdf':
                    echo "<h3>$file_name (PDF File)</h3>";
                    echo "<embed src='{$relative_path}$file_name' width='600' height='400' type='application/pdf' alt='pdf'><br>";
                    break;
                ...
                case 'image':
                    ...
                    echo "<img src='{$relative_path}$file_name' alt='image' width='400' /><br>";
                    break;
